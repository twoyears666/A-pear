...
Pear did not start from zero — it stands on the shoulders of those who came before:

- **[Amethyst](https://github.com/AngelAuraMC/Amethyst-iOS)** (AngelAuraMC) — the official Amethyst launcher. Every piece of groundwork that makes Minecraft: Java Edition genuinely run on iOS — JVM bundling, renderer adaptation, input handling — originated from this project.

- **[Amethyst iOS Remastered](https://github.com/herbrine8403/Amethyst-iOS-MyRemastered)** (herbrine8403) — the Remastered edition and Pear's direct upstream. Much of what you see and use today — the modern interface, smart renderer selection, resource management, the multi-account system — carries this original author's dedicated work.

If Pear brings you value, please consider going back to the source and supporting the original author:

> [herbrine8403 on Afdian](https://afdian.com/a/herbrine8403) · [herbrine8403 on Ko-Fi](https://ko-fi.com/herbrine8403)
