...
- (void)checkForUpdate {
    ...
    NSURL *url = [NSURL URLWithString:@"https://github.com/twoyears666/A-pear/releases/latest"];
...
- (void)downloadLatestVersion {
    NSString *urlString = @"https://github.com/twoyears666/A-pear/releases/latest";
